		...
		<div :class="getRootClass(props.disabled, props.rootClass)">
			<Select v-model="modelValue" :disabled="props.disabled">
				<SelectTrigger
						size="brand"
						:class="[
	          'offre-control-select__trigger h-[var(--brand-control-height)] w-full rounded-[var(--brand-radius-button)] border border-brand-control-border bg-brand-card px-4 py-0 text-left text-[length:var(--brand-text-control)] leading-[var(--brand-leading-control)] text-[var(--brand-select-trigger-foreground,var(--brand-foreground))] data-[state=open]:bg-brand-card hover:border-brand-primary hover:bg-brand-card hover:text-brand-primary [&_svg]:text-[var(--brand-select-trigger-foreground,var(--brand-foreground))]',
	          props.triggerClass
	        ]"
				>
				...
				<SelectContent
						:body-lock="false"
						:class="[
	          'offre-control-select__content overflow-hidden rounded-[var(--brand-radius-media)] border-[var(--brand-border)] shadow-brand-popover',
	          props.contentClass
	        ]"
				>
					<SelectItem
